...
- **管理**: `/admin/horse-prediction-converter.html`
...
const symbols = parts.slice(0, -1).join(''); // それ以外 = 印
```
...
1. **3ファイル同時修正**: static/ public/ admin/ すべて同一コードに保つ
